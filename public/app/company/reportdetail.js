define(['plugins/router', 'account/account', 'company/Company', 'viewmodels/ordersviewmodel', 'order/order', 'quote/quote'], function (router, account, Company, ordersviewmodel, Order, Quote) {
    var ctor = function () {
        ...
        self.activate = function (speedyid) {
            ...
            var payload = {
                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        //CurrentYearQuotesTotal
                        //quotesTotalByYears
                        //quotesByQuarter
                        //averageQuotesByQuarter
                        //quotesByMonth
                        //quoteCountByQuarter
...
//                self.getOrders(speedyid);
//            }
//            if (self.quotes.length == 0) {
//                //self.getQuotes(speedyid);
//            }
//
////            self.getCurrentYearOrdersTotal();
//            self.getCurrentYearQuotesTotal();
//            self.salesTotalByYears();
//            self.salesByMonth();
//            self.salesByQuarter();
//            self.quartersAverages(speedyid);
