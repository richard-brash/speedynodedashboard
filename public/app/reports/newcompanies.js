define(['plugins/router', 'account/account', 'moment'],
function (router, account, moment) {
    var ctor = function () {

        var NewCompany = function(data){
            var nc = this;
            nc.customer_id = ko.observable(data.customer_id);
            nc.Company = ko.observable(data.Company_Name);
            nc.City = ko.observable(data.city);            
            nc.Date = ko.observable(data.cust_enter_date);
        }
        ...
        self.activate = function () {
            self.getNewCompanies();
        };

        self.getNewCompanies = function () {
